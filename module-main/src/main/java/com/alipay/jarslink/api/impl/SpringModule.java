 ...
 *  * You may obtain taobao copy of the License at
 *  *
...
public class SpringModule implements Module {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(com.alipay.jarslink.api.impl.SpringModule.class);
